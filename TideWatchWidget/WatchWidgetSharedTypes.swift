...
struct WidgetSharedData: Codable, Sendable {
    ...
    // Fuseau horaire du port -> la complication affiche les heures en LOCAL du port
...
// MARK: - Shared Unit Formatter (watch widget)
...
enum SharedUnitFormatter {
    ...
    /// Vitesse de vent (km/h) dans l'unite reglee (primee depuis l'iPhone).
